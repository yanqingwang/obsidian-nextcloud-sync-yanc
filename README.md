...
- **Actionable error messages** — native exception strings ("SocketException: Connection reset", "SSLException", …) are translated into guidance, including the manual app-password fallback.
